...
describe Game do
  ...
  describe 'scope' do
    ...
    context "Games with teacher,trivia and answers" do
      before :each do
        (1..4).each do |index_t|
      ...
      describe "week ago by trivia" do
        it "all games in this weeks" do
          games = Game.week_ago_group_by_trivia
          expect(games.length).to eq(4)
        end

        it "count all games in this weeks" do
          games = Game.week_ago_group_by_trivia
          games.each do |g|
            expect(games.count[g.trivia.id]).to eq(4)
          end
        end
        ...
        it "count half of the games in this week" do
          Game.all.each_slice(8).first.each do |g|
            g.update(updated_at: 1.week.ago)
          end
          games = Game.week_ago_group_by_trivia
        ...
        it "count even games in this week" do
          Game.all.each_with_index do |g,index|
            g.update(updated_at: 1.week.ago)  if index.even?
          end
          games = Game.week_ago_group_by_trivia
          games.each do |g|
            expect(games.count[g.trivia.id]).to eq(2)
          end
        end
      ...
      describe "joins answers" do
        it "joins games with answers" do
          games = Game.joins_answers
          expect(games.length).to eq(16)
        end

        it "half joins games with answers" do
          Game.all.each_slice(8).first.each do |g|
            g.update(answers: [])
          end
          games = Game.joins_answers
        ...
        it "even joins games with answers" do
          Game.all.each_with_index do |g,index|
        ...
        it "empty joins games with answers" do
          Game.all.each do |g|
            g.update(answers: [])
          end
          games = Game.joins_answers
      ...
      describe "answers was correct" do
        it "games answers was correct" do
          games = Game.answers_was_correct
          expect(games.length).to eq(16)
        end

        it "half games answers was correct" do
          Game.all.each_slice(8).first.each do |g|
        ...
        it "even games answers was correct" do
          Game.all.each_with_index do |g,index|
        ...
        it "empty games answers was correct" do
          Game.all.each do |g|
            g.answers.first.update(was_correct: false)
          end
          games = Game.answers_was_correct
