...
ActiveRecord::Schema.define(version: 20140623225635) do
  ...
  add_index "admins", ["teacher_id"], name: "index_admins_on_teacher_id"
  ...
  create_table "companies", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "limit_of_teachers"
    t.integer  "limit_of_users"
  ...
  add_index "institutes", ["company_id"], name: "index_institutes_on_company_id"
  ...
  add_index "teachers", ["company_id"], name: "index_teachers_on_company_id"
